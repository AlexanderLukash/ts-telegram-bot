...
SELECT web_chat_id, telegram_chat_id FROM chat_web_mapping WHERE telegram_chat_id = ?
LIMIT 1
"""
GET_CHAT_INFO_BY_WEB_ID = """
SELECT web_chat_id, telegram_chat_id FROM chat_web_mapping WHERE web_chat_id = ?
LIMIT 1
"""
GET_CHATS_COUNT = """
...
"""
DELETE_CHAT_QUERY = """
DELETE FROM chat_web_mapping WHERE web_chat_id = ? OR telegram_chat_id = ?
"""
